  ...
  <section class="bebas-body">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="border-right: 1px solid #d7d7d7;">
          <p><a href="<?php echo url('/manage'); ?>" class="active">Debit Statement <i class="fa fa-caret-right"></i></a></p>
          <p><a href="<?php echo url('/managecredit'); ?>">Credit Statement</a></p>
          <p><a href="<?php echo url('/managejob'); ?>">Jobs Manager</a></p>
        </div>

        <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
          <?php if($pending_count == 0 AND $paid_count == 0): ?>
            <p>No debit recorded for any job</p>
          <?php endif; ?>
