...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Dec 07, 2017 at 04:42 PM
...
(10, 'https _cdn.evbuc.com_images_38329833_126445961951_1_original.jpg', NULL, '2017-12-07 03:53:19', '2017-12-07 03:53:19'),
(11, 'https _cdn.evbuc.com_images_37202263_229071390259_1_original.jpg', NULL, '2017-12-07 03:55:11', '2017-12-07 03:55:11'),
(12, 'https _cdn.evbuc.com_images_36107319_222096919336_1_original.jpg', NULL, '2017-12-07 03:56:45', '2017-12-07 03:56:45'),
(13, 'https _cdn.evbuc.com_images_37843965_235903812755_1_original.jpg', NULL, '2017-12-07 03:59:45', '2017-12-07 03:59:45'),
(14, '21664af375c341723bf57566e3a93d9f.jpg|1277705.jpg', NULL, '2017-12-07 14:57:18', '2017-12-07 14:57:18'),
(15, '8abf3a6c3035555c1bc76b4cee6691ba.jpg|402669712-coral-wallpapers.jpg', NULL, '2017-12-07 15:14:02', '2017-12-07 15:14:02');
...
(11, 1, 0, 'BEBAS Completed Job', '<h4>Hi, dear Yap Siew Yang</h4><br><br><p>We are glad to inform you that your job titled <b><em>The Launch of EVERYTHING KRISTANG - The Malaccan-Portuguese Cookbook</em></b>,has been completed by the the client.</p><p><br>Go to MyJob tab to check <br><p>Thank you</p><br><br>', 0, '2017-12-07 14:44:42'),
...
(14, 1, 3, 'Nothing just to test inbox', '<p><code><span class=\"html\">After wrestling with DateTime::diff for a while\n it finally dawned on me the problem was both in the formatting of the \ninput string and the formatting of the output.\n<br>\n<br>The task was to calculate the duration between two date/times.\n<br>\n<br>### Calculating Duration \n<br>\n<br>1. Make sure you have a valid date variable.&nbsp; Both of these strings are valid:\n</span></code><br></p>', 0, '2017-12-07 04:43:37'),
(15, 1, 0, 'BEBAS Job Application', '<h4>Hi, dear Yap Siew Yang</h4><br><br><p>We are glad to inform you that your application for job titled <b><em>Web Development for Absolute Beginners</em></b>,has been submitted to our system. We will always make sure that you are informed on any updates<br>from our side.</p><p><br>Go to MyJob tab to check either your application is accepted or not. Once accepted,<br>you can expect to see that job showed up within your taken job section.</p><br><br><br><p>Thank you</p><br><br>', 1, '2017-12-07 14:42:14'),
(16, 3, 0, 'BEBAS Completed Job', '<h4>Hi, dear Ahmad Syahrul Ridzwan</h4><br><br><p>We are glad to inform you that your job titled <b><em>Web Development for Absolute Beginners</em></b>,has been completed by the the client.</p><p><br>Go to MyJob tab to check <br><p>Thank you</p><br><br>', 1, '2017-12-07 14:57:25'),
(17, 3, 0, 'BEBAS Completed Job', '<h4>Hi, dear Ahmad Syahrul Ridzwan</h4><br><br><p>We are glad to inform you that your job titled <b><em>Web Development for Absolute Beginners</em></b>,has been completed by the the client.</p><p><br>Go to MyJob tab to check <br><p>Thank you</p><br><br>', 1, '2017-12-07 14:57:41'),
(18, 3, 0, 'BEBAS Completed Job', '<h4>Hi, dear Ahmad Syahrul Ridzwan</h4><br><br><p>We are glad to inform you that your job titled <b><em>Web Development for Absolute Beginners</em></b>,has been completed by the the client.</p><p><br>Go to MyJob tab to check <br><p>Thank you</p><br><br>', 1, '2017-12-07 15:01:36'),
(19, 3, 0, 'BEBAS Job Application', '<h4>Hi, dear Ahmad Syahrul Ridzwan</h4><br><br><p>We are glad to inform you that your application for job titled <b><em>Lego Serious Play (For Adults) - 10X Performers</em></b>,has been submitted to our system. We will always make sure that you are informed on any updates<br>from our side.</p><p><br>Go to MyJob tab to check either your application is accepted or not. Once accepted,<br>you can expect to see that job showed up within your taken job section.</p><br><br><br><p>Thank you</p><br><br>', 1, '2017-12-07 15:08:10'),
(20, 3, 0, 'BEBAS Accepted Application', '<h4>Hi, dear Ahmad Syahrul Ridzwan</h4><br><br><p>We are glad to inform you that your application for job titled <b><em>Lego Serious Play (For Adults) - 10X Performers</em></b>,has been accepted by the owner.</p><p><br>Go to MyJob tab to check either your application is accepted or not. Once accepted,<br>you can expect to see that job showed up within your taken job section.</p><br><br><br><p>Thank you</p><br><br>', 1, '2017-12-07 15:10:01'),
(21, 2, 0, 'BEBAS Completed Job', '<h4>Hi, dear Sivarajan Prashan</h4><br><br><p>We are glad to inform you that your job titled <b><em>Lego Serious Play (For Adults) - 10X Performers</em></b>,has been completed by the the client.</p><p><br>Go to MyJob tab to check <br><p>Thank you</p><br><br>', 1, '2017-12-07 15:14:04');
...
(17, 7, 1, 2, 'I want to take this job', '2017-12-07 14:42:14', '2017-12-07 14:43:18'),
(18, 10, 3, 2, 'Lego', '2017-12-07 15:08:10', '2017-12-07 15:08:44');
...
(9, 'LumiSpa celebration & networking party', 2, NULL, 0, 1, 25, 1, '<p><br></p><h3 class=\"label-primary\">Description</h3><p>\n								\n									<br></p><div class=\"js-xd-read-more-toggle-view read-more__toggle-view\">\n										<div class=\"js-xd-read-more-contents l-mar-top-3\" data-automation=\"listing-event-description\">\n											<p>We are organising a party to celebrate the record sales or ageLOC Lumi Spa achieving a complete SOLD OUT Within SIX (6) minutes.</p>\n<p>✅Lumispa Lucky Draw <br>✅Hi Tea<br>✅Lumi/Galvanic Spa/AgelocME Trial</p>\n<p>We welcome all to celebrate with us !</p>\n										</div>\n									</div><p><br></p>', '2017-12-27', 10, NULL, '2017-12-07 03:53:41', '2017-12-07 03:53:41'),
(10, 'Lego Serious Play (For Adults) - 10X Performers', 2, 3, 0, 1, 26, 3, '<p><span>Price: 2500RM per pax </span></p>\n<p><span>Special Early Bird Deal: Register before 15 Nov 17<br></span>(recieve a special exclusive group coaching session after the class for the first 10pax) </p>\n<p>2 Pax Deal: 4888 RM </p>\n<p>4 Pax Deal: 8888 RM</p>\n<p><br></p>\n<p class=\"qtext_para\"><strong>Why now? </strong><br><br>When will be a \nbetter time to invest in yourself to kickstart your 2018 with clarity \nand goals through Lego. Do not miss this opportunity to give your child \nthe edge above the rest. Spend the holiday at this incredible workshop \nwhere your child will learn and growth through the Power of Play. \nRegister your seats today. Limited seating only. </p>\n<p>The LEGO® SERIOUS PLAY® methodology is a radical, innovative, \nexperiential process designed to enhance business performance. It is \nbased on the belief that everyone can contribute to the discussion, the \ndecisions and the outcome.</p>\n<p>The use of LEGO® elements enables you to take a speedy shortcut to \nthe core. The LEGO elements work as a catalyst – and when used for \nbuilding metaphors, they trigger processes that you probably were \npreviously unaware of.</p>\n<p>Workshop participants leave with skills to communicate more \neffectively, to engage their imagination more readily, and to approach \ntheir work with increased confidence, commitment and insight. </p>\n<p><img src=\"https://cdn.evbuc.com/eventlogos/227479037/legoseriousplay.png\"></p>\n<p><strong>Who will be speaking and teaching?</strong></p>\n<p>Jedidiah Alex is a leading expert in using Lego for strategic \nthinking, problem solving and creativity. He is from Singapore and will \nbe coming to Malaysia for this one day event to inspire and create \nmassive impact for the youth. He has been coaching and training \ncorporates and youths for over 12 years, author and speaker. He is \ncertifed by Lego to facilitate the <span>LEGO® SERIOUS PLAY®</span><span> method. He is also a certifed Master Coach in NLP, ICF. </span></p>', '2017-12-04', 11, 15, '2017-12-07 03:55:39', '2017-12-07 15:14:04'),
(11, 'K-POP Dance Boot Camp Dancers Needed', 2, NULL, 0, 2, 27, 1, '<div class=\"js-xd-read-more-toggle-view read-more__toggle-view\">\n										<div class=\"js-xd-read-more-contents l-mar-top-3\" data-automation=\"listing-event-description\">\n											<p>We enjoy the upbeat music from Big Bang, BTS, EXO and \nother K-POP Bands. We sing along when the music is played but have you \never wanted to learn their dance?</p>\n<div>\n<p><br>This 2-day K-POP Dance Boot Camp is here for you to dance along \nwith your favourite K-POP music! Enjoy the moment with other K-POP \nlovers and have a great time sharing with each other! Open for anyone \naged 12 &amp; above, beginner and intermediate dancers are welcome! Boot\n Camp will start at 9:30am till 5:30pm on both days. </p>\n<p><br><span><strong>Perks:</strong><br></span><span>i) We will shoot your Dance Cover Video at the end of the boot camp<br></span><span>ii) Stand a chance to be selected as TeenEdge official </span>dance team</p>\n<p><span>Register now to enjoy 30% off for Eventbrite user!</span></p>\n<p><span>*Regular rate at RM200.</span></p>\n<p><span>*Lunch included</span></p>\n</div>\n										</div>\n									</div>', '2018-01-06', 12, NULL, '2017-12-07 03:57:03', '2017-12-07 03:57:03'),
(12, 'Timeless Thanjavur : Arts & Royalty Performer', 2, NULL, 0, 2, 28, 1, '<div class=\"js-xd-read-more-toggle-view read-more__toggle-view\">\n										<div class=\"js-xd-read-more-contents l-mar-top-3\" data-automation=\"listing-event-description\">\n											<p><span>WOWGA Creativarium in collaboration with Netaji \nSubash Chandra Bose Indian Cultural Centre - High Commission of India, \nKuala Lumpur and Tanjai Kamalaa Indira Dance School, proudly present:-</span><br><br><span>TIMELESS THANJAVUR...Arts &amp; Royalty</span><br><br><span>Featuring\n a solo Bharathanatyam recital with live orchestra by \'Natya Sironmani\' \nKamini Manikam on rare pieces from the traditional Thanjavur repertoire.\n Followed by a book release titled \"Contributions of Thanjavur Maratha \nKings\" by Prince Pratap Sinh Serfoji Raje Bhosle, a 6th descendant of \nKing Serfoji II.</span><br><br><span>Orchestra: ‘Nattuva Thilagam’ \nSrimathi Indira Manikam (Nattuvangam), Thiepaan Raaj (Vocal), Prathap \nSharma (Mridangam) &amp; Achyuthan Sashidaran Nair (Violin) </span><br><br><span>Date: 16th December 20</span><span class=\"text_exposed_show\">17 (Saturday)<br>Time: 7.30pm (Refreshments will be served at 7.00pm)<br>Venue: Netaji Subash Chandra Bose<br>Indian Cultural Centre, Menara Sentral Vista,<br>No.17-2 &amp; 17-3A (17th floor), Jln Sultan Abdul Samad, Brickfields, Kuala Lumpur<br>Admission: RM ∞ (Attend with infinite love...some of the best things in life are FREE)<br><br><span>For further details, call 03-22763492 /</span><span class=\"word_break\"></span><span> 0129149951 or email us at indianculturalcentre.kl@gmai</span><span class=\"word_break\"></span><span>l.com; wowga.creativarium@gmail.c</span><span class=\"word_break\"></span>om</span></p>\n										</div>\n									</div>', '2018-01-26', 13, NULL, '2017-12-07 04:00:03', '2017-12-07 04:00:03');
...
(5, '<p>I am not provided with a workstation. Sorry, but i did not have an appropriate workstation for this job<br></p>', 7, 1, '2017-12-07 14:50:56'),
(6, '<p>Thank you for pointing out that issue. WIll try to get you a Mac Pro.<br></p>', 7, 3, '2017-12-07 14:55:55'),
(7, '<p>Thank you. Please make it quick ya<br></p>', 7, 1, '2017-12-07 14:56:47');
...
(23, 3400, 'RM', 1, 1, 3, '2017-12-06 04:27:42', '2017-12-07 14:43:18'),
(24, 3500, 'RM', NULL, 1, 3, '2017-12-06 04:30:54', '2017-12-06 04:30:54'),
(25, 1000, 'RM', NULL, 1, 2, '2017-12-07 03:53:41', '2017-12-07 03:53:41'),
(26, 2000, 'RM', 3, 1, 2, '2017-12-07 03:55:39', '2017-12-07 15:08:44'),
(27, 500, 'RM', NULL, 1, 2, '2017-12-07 03:57:02', '2017-12-07 03:57:02'),
(28, 230, 'RM', NULL, 1, 2, '2017-12-07 04:00:03', '2017-12-07 04:00:03');
...
(1, 'Yap Siew Yang', '0123464434', '1415813', '2', 'He-Zi-1.jpg', '1', 'yapsiew@gmail.com', '$2y$10$iCcJWgQvcUcVc81MlWfdF.BH1.2ITKBHzlh5LRr4O4LxhaM3rPbeK', 'SvT2MIdAThJ46JuyA6H9EM1GApq3RozfcbEailtFIPPehcTbPpQtcZtqbD9O', '2017-12-05 20:02:58', '2017-12-05 20:02:58', 'Web Designer', NULL, 0),
(2, 'Sivarajan Prashan', '0134556631', '1227655', '2', 'terror19n-4-web.jpg', '1', 'prashan@yahoo.com', '$2y$10$3J9UfAsf/XrIUT42GFs3JesTscse5G6k2htkCslEvSqBRua7/ttwC', '17Ap0Rqu2bB2THurSQr3ee1rPy96fVVTGbRNvcUo3kWCCZnipoDbrooDI5MY', '2017-12-05 20:10:39', '2017-12-05 20:10:39', 'Videographer', NULL, 0),
(3, 'Ahmad Syahrul Ridzwan', '0117621346', '1415224', '2', '1391828816_1533493466.jpg', '1', 'syarulzacky@gmail.com', '$2y$10$5hVduSG4ZNrDFr2nh9o90.3wXUYIt8eLL4O4GW0Rxlv2lVVlnMiXS', 'Cd2CH2Si3BBMa1VTvjAUtdQ3Xc5XagMTPluMdnYHbl2fz6xF4e7BlSwaB9K0', '2017-12-05 20:16:25', '2017-12-05 20:16:25', 'Web Designer', NULL, 3);
...
--
ALTER TABLE `attachment_bebas`
  MODIFY `attach_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
